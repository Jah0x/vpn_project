...
## 2025-08-30
- Добавлена зависимость axios и package-lock.json для воспроизводимых сборок.
- Dockerfile фронтенда теперь использует npm ci и копирует lock-файл.
- В CI добавлена проверка сборки образа фронтенда.
